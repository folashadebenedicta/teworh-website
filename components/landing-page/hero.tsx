...
export function HeroSection() {
  return (
    <section className="relative overflow-hidden bg-white">
      <div className="mx-auto flex max-w-360 flex-col items-center gap-10 px-4 py-14 sm:px-6 lg:flex-row lg:items-center lg:gap-0 lg:px-8 lg:py-0">
        {/* LEFT: copy */}
        <div className="flex flex-1 flex-col items-center gap-3 text-center lg:items-start lg:pr-8 lg:text-left">
          <div className="flex flex-col items-start">
            ...
            <div className="flex items-center justify-center gap-x-2 lg:justify-start">
              {' '}
              <span className="text-secondary-foreground font-redrose text-[clamp(3rem,5.5vw,4.6875rem)] leading-none font-bold">
                Go
              </span>
              <span className="font-redrose inline-flex items-center text-[clamp(4.2rem,10.5vw,9.375rem)] leading-none font-bold text-[#3B924C]">
                Sp
                <span
            ...
            <div className="flex items-center justify-center gap-x-2 lg:justify-start">
              ...
              <span className="font-redrose text-[clamp(4.2rem,10.5vw,9.375rem)] leading-none font-bold text-[#3B924C]">
                Teworh
              </span>
            </div>
          </div>
          ...
          {/* CTAs */}
          <div className="z-10 mt-4 flex flex-wrap items-center justify-center gap-4 lg:justify-start">
            <Button
              asChild
              variant="accent"
              size="pill"
      ...
      {/* Mobile-only: bottom-right collage peek */}
      <div className="pointer-events-none absolute right-0 bottom-0 h-62 w-4/5 lg:hidden">
        <Image
          src="/images/hero-img-mobile.png"
          alt=""
          fill
          priority
          className="rounded-tl-2xl object-cover object-top-left"
        />
      </div>
    </section>
  )
