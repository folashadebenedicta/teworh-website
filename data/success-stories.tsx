...
export const stories: Story[] = [
  {
    ...
    body: [
      ...
      "Beyond the pitch, Teworh opened doors I never expected, including a humanitarian MBA from Roxboury Institute, earned under Teworh Rockstar Academy's scholarship and guidance.",
      'I am proud to wear this badge. Loyal to this family. Always.',
      '"Teworh built me into a leader — on the pitch, and in life."',
    ],
    image: '/images/successstory-1.png',
    alt: 'Lukman Lawal in football kit',
  },
  {
    name: 'Khalifah, Shehu',
  ...
  },
  {
    ...
    body: [
      ...
      'I am proud to be part of this family, and excited for everything still to come.',
      '"Teworh gave me more than football. It gave me faith in what\'s possible."',
    ],
    image: '/images/successstory-3.png',
    alt: 'Steven running on pitch',
  },
  {
    ...
    image: '/images/successstory-4.png',
    alt: 'Benedict Jacob Kaita in white jersey',
  },
  {
    ...
    body: [
      ...
      "This isn't just about playing football anymore. It's about building a future with purpose.",
      '"Teworh gave me the opportunity to be seen, to grow, and to truly believe in myself."',
    ],
    image: '/images/successstory-5.png',
    alt: 'Kasnom Obed Ricksom in yellow jersey',
  },
  {
    ...
    image: '/images/successstory-6.png',
  ...
  },
  {
    ...
    body: [
      ...
      'We trained at Ahmadu Bello Stadium, competed in domestic tournaments, explored table tennis and badminton, and watched teammates earn scouting opportunities across the globe. Teworh saw potential in everyone and left no one behind.',
      'Today I lead a student union, finish my final year with strong grades, and hold a resume built on the hard and soft skills Teworh gave me.',
      '"Words cannot capture what Coach Suraj and Teworh engraved in me. I am simply a better person because of them."',
    ],
    image: '/images/successstory-7.png',
  ...
  },
  {
    ...
    body: [
      ...
      'Every day, Teworh pushes me to aim higher.',
      '"Grateful for the influence, the lessons, and the path Teworh continues to inspire in us."',
    ],
    image: '/images/successstory-8.png',
    alt: 'Evans in black hoodie on pitch',
  },
  {
    name: 'Samuel, Ezeoye',
    ...
    image: '/images/successstory-9.png',
    alt: 'Samuel Ezeoye holding a document',
  },
  {
    name: 'Sadiq, Muhammed',
    ...
    body: [
      ...
      "Teworh taught me that size doesn't define your ceiling. Vision, resilience, and hard work do.",
      "Today, I don't just play football, I use it to inspire younger players who feel limited by what they look like or where they come from.",
      '"Teworh didn\'t just make me a better footballer. It made me a better leader."',
    ],
    image: '/images/successstory-10.png',
    alt: 'Sadiq Muhammed with ball on pitch',
  },
  {
    ...
    alt: 'Ayman Mouktar Sirajo in team photo',
  },
]
